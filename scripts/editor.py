...
class Editor:
    def __init__(self):
        ...
        try:
            #self.tilemap.load('data/maps/' + input("Map name:") + '.json')
    ...
    def run(self):
        ...
        while True:
            ...
            if(self.ongrid):
                ...
                self.display.blit(current_tile_img, (mouse_pos[0] - (self.tilemap.tile_size / 2), mouse_pos[1] - (self.tilemap.tile_size / 2)))
            #place tiles
            ...
            if(self.right_clicking):
                ...
                for tile in self.tilemap.offgrid_tiles.copy():
                    ...
                    tile_hitbox = pygame.Rect(tile["pos"][0] - self.scroll[0], tile["pos"][1] - self.scroll[1], tile_img.get_width(), tile_img.get_height())
                    if tile_hitbox.collidepoint(mouse_pos):
            ...
            for event in pygame.event.get():
                    ...
                    if(event.button == 1):
                        ...
                        if(not self.ongrid):
                            self.tilemap.offgrid_tiles.append({"type": self.tile_list[self.tile_group], 
                                                               ...
                                                               "pos": (mouse_pos[0] - (self.tilemap.tile_size/2) + self.scroll[0], mouse_pos[1] - (self.tilemap.tile_size/2) + self.scroll[1])})
                    if(event.button == 3):
                ...
                if(event.type == pygame.KEYDOWN):
                    ...
                    if(event.key == pygame.K_e):
                        #self.tilemap.save("data/maps/" + input("Map name:") + ".json")
                        self.tilemap.save("data/maps/my_map.json")
